    ...
    <main class="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 -mt-10 relative z-20 print:mt-0 print:px-0">
      ...
      <footer class="mt-16 border-t border-slate-200 py-8 text-center print:hidden">
        <div class="flex flex-row flex-wrap items-center justify-center gap-12">
          ...
          <a href="https://github.com/jord3v/simular-cdi" target="_blank" rel="noopener noreferrer" class="flex items-center gap-3 hover:opacity-80 transition-opacity text-left">
          ...
          <a href="https://github.com/jord3v/simular-cdi/releases/latest/download/app-release.apk" target="_blank" rel="noopener noreferrer" class="flex items-center gap-3 hover:opacity-80 transition-opacity text-left">
